...
<body>
    ...
    <?php
        ...
        <form action="unauthorize.php" method="post" class="account-form">
            ...
            <?php
            $sql = "SELECT email FROM user WHERE type = 1";
            ...
            <div class="form-group">
                <label for="email">Remove a Teacher</label>
            ...
            <button type="submit" class="submit-button">Unauthorize</button>
        </form>
    </div>
