...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateSQL = "INSERT INTO notice (title, download, date) VALUES ('$title', '$file', '$date')";

    if ($conn->query($updateSQL) === TRUE) {
        // Redirect to account page after successful update
        $error_message="New Notice Added Successfully !";
    } else {
        // Handle error
    }
}
...
<body>
    ...
    <div class="bottom">
        <form action="new_notice.php" method="post" class="account-form">
