...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateSQL = "DELETE from user WHERE email = '$email'";
            ...
            if ($_SESSION["user_type"] == 2) { ?>
                <div class="buttons">
                    ...
                    <div class="new-question">
                        <a href="unauthorize.php" class="add">- Unauthorize A Teacher</a>
                    </div>

                    <div class="new-chapter">
                        <a href="authorization.php" class="add">+ Authorize a Teacher</a>
                    </div>
                </div> <?php }
                } ?>

        <form action="deleteuser.php" method="post" class="account-form">
            ...
            <?php
            $sql = "SELECT email FROM user WHERE type < 2";
            ...
            <div class="form-group">
                <label for="email">Delete a User</label>
